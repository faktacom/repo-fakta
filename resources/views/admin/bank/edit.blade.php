...
<div class="card-group">
    <div class="card">
        <form action="{{route('admin.bank.update', $detail_bank_image[0]->image_id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="image_title" class="form-control form-control-sm"
                                placeholder="Enter title" value="{{$detail_bank_image[0]->image_title}}">
                        </div>
                        <div class="form-group">
                            <label for="">Caption</label>
                            <input type="text" name="image_caption" class="form-control form-control-sm"
                                placeholder="Enter caption" value="{{$detail_bank_image[0]->image_caption}}">
                        </div>
                        <div class="form-group">
                            <label for="">Image</label>
                            <input type="file" name="image_path" class="form-control form-control-sm" onchange="readURL(this);">
                            <img src="{{asset("assets/news/images/".$detail_bank_image[0]->image_path)}}" id="preview" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
