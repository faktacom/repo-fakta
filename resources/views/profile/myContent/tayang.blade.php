...
@foreach ($tayang as $news)
<div class="updates-card" data-newsid="{{$news->news_id}}">
    <div class="row">
            ...
            <div class="description-updates">
                ...
                <div class="content-description">
                    ...
                    <div class="action">
                        ...
                        <a href="#" type="button" data-toggle="modal" data-target="#deleteModal{{$news->news_id}}"
                            class="hapus">Hapus</a>
                    </div>
                </div>

                <div class="modal fade" id="deleteModal{{$news->news_id}}" tabindex="-1" role="dialog"
                    aria-labelledby="deleteModal{{$news->news_id}}Title" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6>Apa anda yakin ingin menonaktifkan berita ini?
                                </h6>
                                <div class="row justify-content-center mt-3">
                                    <div class="col-lg-7">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                    <button type="button" data-pointid="{{$news->news_id}}"
                                                        class="btn btn-danger btn-block btn-sm btn-hapus">Ya</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@endforeach
{{$tayang->withPath('/profile/my-content?tab=tayang')->links('pagination::bootstrap-4')}}

@push('js')
<script>
    // function loadMoreData(page) {
    //     $.ajax({
    //         url: '?tab=tayang&page=' + page,
    //         type: 'get',
    //         timeout: 5000
    //         beforeSend: function () {
    //             $(".ajax-load").show();
