...
@if (isset($draft) && $draft->count() > 0)
    @foreach ($draft as $news)
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h6>Data yang sudah di hapus tidak dapat dikembalikan lagi, Anda yakin ingin menghapus?
                                    </h6>
    ...
    @endforeach
    {{$draft->withPath('/profile/my-content?tab=draft')->links('pagination::bootstrap-4')}}
@else
